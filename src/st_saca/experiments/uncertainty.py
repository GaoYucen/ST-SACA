...
try:
    from st_saca.experiments.train import main as train_main
except ImportError:
    train_main = None
    print("Warning: training entrypoint not found. Only plotting mode is available.")
...
def run_experiments():
    ...
    if train_main is None:
        raise RuntimeError("Training entrypoint is unavailable.")
