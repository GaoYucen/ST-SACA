...
# (e.g., `from st_saca.routing.am_test import presingle`), absolute imports like
...
import os, pathlib
from st_saca.paths import DATA_DIR, ROUTING_CKPT_DIR, require_file
...
def eval():
    ...
    N_HEADS = 8
    N_LAYERS = 3
    LOAD_PATH = require_file(ROUTING_CKPT_DIR / "best_model.pth", "Routing model checkpoint")
    EVALBATCH_SIZE = 64
