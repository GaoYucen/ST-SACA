...
class CaseCfg:
    ...
    demand_max: int = 8
    # where to save
    out_dir: str = str(OUTPUT_DIR / "figures" / "case_study")
    # saving
...
def _infer_price_vectors(N_p: np.ndarray):
    ...
    # ST-SACA
    from st_saca.agents import st_saca as STSACA
    ...
    # SACA baseline
    from st_saca.agents import saca_baseline as SACA
    ...
    # GRC-ELG
    from st_saca.baselines import grc_elg as GRC
    ...
    # JDRL-POMO
    from st_saca.baselines import jdrl_pomo as JDRL
